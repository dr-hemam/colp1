...
INSERT INTO `alembic_version` VALUES ('963ac40cfd96');
...
INSERT INTO `constraintanalysis` VALUES (1,1,1,1,NULL,1),(2,1,1,1,NULL,2),(3,1,2,1,NULL,1);
...
INSERT INTO `constraintanalysis_details` VALUES (1,17,1,1,1,1),(1,17,2,1,1,1),(1,17,3,1,1,1),(1,17,4,1,1,1),(1,17,6,1,1,1),(1,17,7,1,1,1),(1,17,8,1,1,1),(1,18,1,1,1,1),(1,18,2,1,1,1),(1,18,3,1,1,1),(1,18,4,1,1,1),(1,18,6,1,1,1),(1,18,7,1,1,1),(1,18,8,1,1,1),(2,19,1,1,1,1),(2,19,2,1,1,1),(2,19,3,0,1,1),(2,19,4,0,1,1),(2,19,6,0,1,1),(2,19,7,0,1,1),(2,19,8,0,1,1),(3,21,1,1,1,1),(3,21,2,1,1,1),(3,21,3,1,1,1),(3,21,4,1,1,1),(3,21,6,1,1,1),(3,21,7,1,1,1),(3,21,8,1,1,1),(3,22,1,1,1,1),(3,22,2,1,1,1),(3,22,3,1,1,1),(3,22,4,1,1,1),(3,22,6,1,1,1),(3,22,7,1,1,1),(3,22,8,1,1,1);
...
INSERT INTO `lookaheads` VALUES (7,1,1,1,1),(8,1,1,1,2),(9,1,1,1,3),(10,1,2,1,1);
...
INSERT INTO `lookaheads_details` VALUES (17,7,'10','Task 10','2016-11-18 00:00:00','2016-11-20 00:00:00',1),(18,7,'20','Task 20','2016-11-22 00:00:00','2016-11-26 00:00:00',1),(19,8,'30','Task 30','2016-11-20 00:00:00','2016-11-24 00:00:00',1),(20,9,'50','Task 50','2016-12-22 00:00:00','2016-12-27 00:00:00',1),(21,10,'Task 24-1','Task 24-1','2016-11-24 00:00:00','2016-11-30 00:00:00',1),(22,10,'Task24-2','Task 24-2','2016-11-26 00:00:00','2016-11-01 00:00:00',1);
...
INSERT INTO `roles` VALUES (1,'Engineer',1,NULL,1),(2,'Jnr Engineer',1,1,1),(3,'Project Controls Manager',1,NULL,1),(4,'Planner',1,3,1),(5,'Junior Planner',1,4,1);
...
INSERT INTO `sections` VALUES (1,'C1','Section C1',1,1,NULL),(2,'C2','Section C2',1,1,NULL),(3,'C3','Section C3',1,1,NULL),(4,'C1-1','Section 1 Area 1',1,1,1),(5,'ALT','Alton Towers',1,1,4);
...
CREATE TABLE `wwp_details` (
  ...
  CONSTRAINT `wwp_details_ibfk_3` FOREIGN KEY (`delayreason_id`) REFERENCES `delay_reasons` (`id`),
...
INSERT INTO `wwp_details` VALUES (1,17,1,1,1,0,0,0,0,0,1,NULL,0),(1,18,0,0,0,1,1,1,0,0,1,NULL,0),(8,21,1,1,1,0,0,0,0,1,1,NULL,1),(8,22,0,0,1,1,1,0,0,0,1,1,1),(12,18,1,1,0,0,1,0,0,0,1,NULL,0),(12,19,1,1,1,0,0,0,0,0,1,NULL,0),(14,20,1,1,1,0,0,0,0,1,1,NULL,1);
...
INSERT INTO `wwps` VALUES (1,1,1,1,NULL,1,0),(8,1,2,1,0.5,1,1),(9,1,3,1,NULL,1,0),(11,1,4,1,NULL,1,0),(12,1,1,2,NULL,1,0),(13,1,2,2,NULL,1,0),(14,1,1,3,1,1,1);
...
-- Dump completed on 2017-05-08 17:28:23
